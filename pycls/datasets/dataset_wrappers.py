...
class RepeatDataset:
    ...
    def __init__(self, dataset, times, test_mode=False,**kwargs):
        dataset['test_mode'] = test_mode
        self.dataset = PoseDataset(**dataset)
    ...
    def __getitem__(self, idx):
        """Get data."""
        return self.dataset[idx % self._ori_len]['keypoint'],self.dataset[idx % self._ori_len]['label']
