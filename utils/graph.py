...
class Graph:
    ...
    def part_graph(self):
        ...
        part_list.append(head)
        right_hand = [
            (22, 8), (23, 8), (7, 6), (8, 7),
        ]
        part_list.append(right_hand)
        left_hand = [
            (24, 12), (25, 12), (12, 11), (11, 10),
        ]
        part_list.append(left_hand)
        right_arm = [
            (5, 21), (6, 5), (7, 6), (8, 7),
        ]
        part_list.append(right_arm)
        left_arm = [
            (9, 21), (10, 9), (11, 10), (12, 11),
        ]
        part_list.append(left_arm)
        trunk = [
            (9, 21), (5, 21), (1, 2), (2, 21),
        ]
        part_list.append(trunk)
        hip = [
            (17, 1), (18, 17), (13, 1), (14, 13),
        ]
        part_list.append(hip)
        right_leg = [
            (13, 1), (14, 13), (15, 14), (16, 15),
        ]
        part_list.append(right_leg)
        left_leg = [
            (17, 1), (18, 17), (19, 18), (20, 19),
        ]
        part_list.append(left_leg)
        ...
        for ind,part in enumerate(part_node):
            ...
            part_inward = np.zeros((len(part), len(part)))
...
if __name__ == '__main__':
    ...
    cfg = Config.fromfile(r'/home/zzf/chenzw/GFNet-Pytorch-master/pycls/cfgs/stgcn++pooling/j_onlypooling.py')
